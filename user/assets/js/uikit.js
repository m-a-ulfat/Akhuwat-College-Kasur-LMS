if (function(t) {
     ...
     d = function(l) {
          ...
          var d = {},
               t = window.UIkit || void 0;
          d.version = "2.27.5", d.noConflict = function() {
               return t && (window.UIkit = t, l.UIkit = t, l.fn.uk = t.fn), d
          }, window.UIkit2 = d, t || (window.UIkit = d);
          if (d.$ = l, d.$doc = d.$(document), d.$win = d.$(window), d.$html = d.$("html"), d.support = {}, d.support.transition = (r = function() {
               ...
               }), d.support.animation = (a = function() {
                    var t, e = document.body || document.documentElement,
                         i = {
               ...
               }, d.Utils.debounce = function(o, n, s) {
                    var a;
                    return function() {
                         var t = this,
                              e = arguments,
                    ...
                    t && setTimeout(function() {
                         try {
                              for (h = document.styleSheets, n = 0, r = h.length; n < r; n++) {
                                   for (o = h[n], i = [], o.cssRules = o.cssRules, e = s = 0, l = o.cssRules.length; s < l; e = ++s) o.cssRules[e].type === CSSRule.STYLE_RULE && t.test(o.cssRules[e].selectorText) && i.unshift(e);
                                   for (a = 0, d = i.length; a < d; a++) o.deleteRule(i[a])
                              }
                         } catch (t) {}
                    }, 0)
                    ...
                    return e = l.extend({
                         topoffset: 0,
                         leftoffset: 0
                    }, e), r + i.height() >= n && r - e.topoffset <= n + d.$win.height() && a + i.width() >= o && a - e.leftoffset <= o + d.$win.width()
                    ...
                    return t && !i.length && (i = l(t)), i.trigger("display.uk.check"), e && ("string" != typeof e && (e = '[class*="uk-animation-"]'), i.find(e).each(function() {
                         var t = d.$(this),
                              e = t.attr("class").match(/uk-animation-(.+)/);
                         t.removeClass(e[0]).width(), t.addClass(e[0])
                    })), i
               }, d.Utils.options = function(t) {
                    if ("string" != l.type(t)) return t; - 1 != t.indexOf(":") && "}" != t.trim().substr(-1) && (t = "{" + t + "}");
                    var e = t ? t.indexOf("{") : -1,
                         i = {};
                    if (-1 != e) try {
                    ...
                    var i = l.Deferred();
                    return (t = d.$(t)).css("display", "none").addClass(e).one(d.support.animation.end, function() {
                         t.removeClass(e), i.resolve()
                    }), t.css("display", ""), i.promise()
               }, d.Utils.uid = function(t) {
                    return (t || "id") + (new Date).getTime() + "RAND" + Math.ceil(1e5 * Math.random())
               }, d.Utils.template = function(t, e) {
                    for (var i, o, n, s, a = t.replace(/\n/g, "\\n").replace(/\{\{\{\s*(.+?)\s*\}\}\}/g, "{{!$1}}").split(/(\{\{\s*(.+?)\s*\}\})/g), r = 0, l = [], d = 0; r < a.length;) {
                         if ((i = a[r]).match(/\{\{\s*(.+?)\s*\}\}/)) switch (o = (i = a[r += 1])[0], n = i.substring(i.match(/^(\^|\#|\!|\~|\:)/) ? 1 : 0), o) {
                              case "~":
                    ...
                    if (!(t = l(t)).length) return t;
                    var i, o = t.find("[autofocus]:first");
                    return o.length ? o.focus() : (o = t.find(":input" + (e && "," + e || "")).first()).length ? o.focus() : (t.attr("tabindex") || (i = 1e3, t.attr("tabindex", i)), t[0].focus(), i && t.attr("tabindex", ""), t)
               }, d.Utils.events = {}, d.Utils.events.click = d.support.touch ? "tap" : "click", d.fn = function(t, i) {
                    var o = arguments,
                         e = t.match(/^([a-z\-]+)(?:\.([a-z]+))?/i),
                         n = e[1],
                         s = e[2];
                    return d[n] ? this.each(function() {
                         var t = l(this),
                              e = t.data(n);
                         e || t.data(n, e = d[n](this, s ? void 0 : i)), s && e[s].apply(e, Array.prototype.slice.call(o, 1))
                    }) : (l.error("UIkit component [" + n + "] does not exist."), this)
               }, l.UIkit = d, l.fn.uk = d.fn, d.langdirection = "rtl" == d.$html.attr("dir") ? "right" : "left", d.components = {}, d.component = function(o, t, e) {
                    if (d.components[o] && !e) return d.components[o];
                    var n = function(t, e) {
                         var i = this;
                         return this.UIkit = d, this.element = t ? d.$(t) : null, this.options = l.extend(!0, {}, this.defaults, e), this.plugins = {}, this.element && this.element.data(o, this), this.init(), (this.options.plugins.length ? this.options.plugins : Object.keys(n.plugins)).forEach(function(t) {
                              n.plugins[t].init && (n.plugins[t].init(i), i.plugins[t] = !0)
                         }), this.trigger("init.uk.component", [o, this]), this
                    };
                    return n.plugins = {}, l.extend(!0, n.prototype, {
                         defaults: {
                              plugins: []
                         },
                         boot: function() {},
                    ...
                    }, t), this.components[o] = n, this[o] = function() {
                         var t, e;
                         if (arguments.length) switch (arguments.length) {
                              case 1:
                                   "string" == typeof arguments[0] || arguments[0].nodeType || arguments[0] instanceof jQuery ? t = l(arguments[0]) : e = arguments[0];
                                   break;
                              case 2:
                                   t = l(arguments[0]), e = arguments[1]
                         }
                         return t && t.data(o) ? t.data(o) : new d.components[o](t, e)
                    }, d.domready && d.component.boot(o), n
               }, d.plugin = function(t, e, i) {
                    this.components[t].plugins[e] = i
               }, d.component.boot = function(t) {
                    d.components[t].prototype && d.components[t].prototype.boot && !d.components[t].booted && (d.components[t].prototype.boot.apply(d, []), d.components[t].booted = !0)
               }, d.component.bootComponents = function() {
                    for (var t in d.components) d.component.boot(t)
               }, d.domObservers = [], d.domready = !1, d.ready = function(t) {
                    d.domObservers.push(t), d.domready && t(document)
               }, d.on = function(t, e, i) {
                    return t && -1 < t.indexOf("ready.uk.dom") && d.domready && e.apply(d.$doc), d.$doc.on(t, e, i)
               }, d.one = function(t, e, i) {
                    return t && -1 < t.indexOf("ready.uk.dom") && d.domready ? (e.apply(d.$doc), d.$doc) : d.$doc.one(t, e, i)
               }, d.trigger = function(t, e) {
                    return d.$doc.trigger(t, e)
               }, d.domObserve = function(t, o) {
                    d.support.mutationobserver && (o = o || function() {}, d.$(t).each(function() {
                         var e = this,
                              i = d.$(e);
                         if (!i.data("observer")) try {
                              var t = new d.support.mutationobserver(d.Utils.debounce(function(t) {
                                   o.apply(e, [i]), i.trigger("changed.uk.dom")
                              }, 50), {
                                   childList: !0,
                                   subtree: !0
                              });
                    ...
                    e = e || document, d.domObservers.forEach(function(t) {
                         t(e)
                    })
               }, d.on("domready.uk.dom", function() {
                    d.init(), d.domready && d.Utils.checkDisplay()
               }), document.addEventListener("DOMContentLoaded", (s = function() {
                    d.$body = d.$("body"), d.trigger("beforeready.uk.dom"), d.component.bootComponents();
                    var i, o, t, n = requestAnimationFrame((i = {
                         dir: {
                              x: 0,
                              y: 0
                         },
                         ...
                         i.x == t && i.y == e || (t != i.x ? i.dir.x = t > i.x ? 1 : -1 : i.dir.x = 0, e != i.y ? i.dir.y = e > i.y ? 1 : -1 : i.dir.y = 0, i.x = t, i.y = e, d.$doc.trigger("scrolling.uk.document", [{
                              dir: {
                                   x: i.dir.x,
                                   y: i.dir.y
                              },
                              x: t,
                              y: e
                         }])), cancelAnimationFrame(n), n = requestAnimationFrame(o)
                    }, d.support.touch && d.$html.on("touchmove touchend MSPointerMove MSPointerUp pointermove pointerup", o), (i.x || i.y) && o(), o));
                    if (d.trigger("domready.uk.dom"), d.support.touch && navigator.userAgent.match(/(iPad|iPhone|iPod)/g) && d.$win.on("load orientationchange resize", d.Utils.debounce((t = function() {
                              return l(".uk-height-viewport").css("height", window.innerHeight), t
                         })(), 100)), d.trigger("afterready.uk.dom"), d.domready = !0, d.support.mutationobserver) {
                         ...
                         new d.support.mutationobserver(function(t) {
                              ...
                              t.every(function(t) {
                                   ...
                                   for (var e, i = 0; i < t.addedNodes.length; ++i)
                                        if ((e = t.addedNodes[i]).outerHTML && -1 !== e.outerHTML.indexOf("data-uk-")) return (o = !0) && !1;
                                   return !0
                              }), o && e()
               ...
               }, "complete" != document.readyState && "interactive" != document.readyState || setTimeout(s), s)), d.$html.addClass(d.support.touch ? "uk-touch" : "uk-notouch"), d.support.touch) {
               var e, i = !1,
                    o = "uk-hover",
               ...
               d.$html.on("mouseenter touchstart MSPointerDown pointerdown", n, function() {
                    i && l("." + o).removeClass(o), i = l(this).addClass(o)
               }).on("mouseleave touchend MSPointerUp pointerup", function(t) {
                    e = l(t.target).parents(n), i && i.not(e).removeClass(o)
               })
          }
          var s;
          var a;
     ...
     if (!a.fn.swipeLeft) {
          ...
          a(function() {
               var e, i, o, n = 0,
                    s = 0;
               "MSGesture" in window && ((c = new MSGesture).target = document.body), a(document).on("MSGestureEnd gestureend", function(t) {
                    ...
                    e && void 0 !== u.el && (u.el.trigger("swipe"), u.el.trigger("swipe" + e))
               }).on("touchstart MSPointerDown pointerdown", function(t) {
                    ("MSPointerDown" != t.type || w(t.originalEvent)) && (o = "MSPointerDown" == t.type || "pointerdown" == t.type ? t : t.originalEvent.touches[0], e = Date.now(), i = e - (u.last || e), u.el = a("tagName" in o.target ? o.target : o.target.parentNode), r && clearTimeout(r), u.x1 = o.pageX, u.y1 = o.pageY, 0 < i && i <= 250 && (u.isDoubleTap = !0), u.last = e, h = setTimeout(g, 750), t.originalEvent && t.originalEvent.pointerId && c && ("MSPointerDown" == t.type || "pointerdown" == t.type || "touchstart" == t.type) && c.addPointer(t.originalEvent.pointerId))
               }).on("touchmove MSPointerMove pointermove", function(t) {
                    ("MSPointerMove" != t.type || w(t.originalEvent)) && (o = "MSPointerMove" == t.type || "pointermove" == t.type ? t : t.originalEvent.touches[0], v(), u.x2 = o.pageX, u.y2 = o.pageY, n += Math.abs(u.x1 - u.x2), s += Math.abs(u.y1 - u.y2))
               }).on("touchend MSPointerUp pointerup", function(t) {
                    ("MSPointerUp" != t.type || w(t.originalEvent)) && (v(), u.x2 && 30 < Math.abs(u.x1 - u.x2) || u.y2 && 30 < Math.abs(u.y1 - u.y2) ? d = setTimeout(function() {
                         var t, e, i, o;
                         void 0 !== u.el && (u.el.trigger("swipe"), u.el.trigger("swipe" + (t = u.x1, e = u.x2, i = u.y1, o = u.y2, Math.abs(t - e) >= Math.abs(i - o) ? 0 < t - e ? "Left" : "Right" : 0 < i - o ? "Up" : "Down"))), u = {}
                    }, 0) : "last" in u && (isNaN(n) || n < 30 && s < 30 ? l = setTimeout(function() {
                         var t = a.Event("tap");
                         t.cancelTouch = k, void 0 !== u.el && u.el.trigger(t), u.isDoubleTap ? (void 0 !== u.el && u.el.trigger("doubleTap"), u = {}) : r = setTimeout(function() {
                              r = null, void 0 !== u.el && u.el.trigger("singleTap"), u = {}
                         }, 250)
                    }, 0) : u = {}, n = s = 0))
     ...
     function g() {
          h = null, u.last && (void 0 !== u.el && u.el.trigger("longTap"), u = {})
     }
     ...
     function k() {
          r && clearTimeout(r), l && clearTimeout(l), d && clearTimeout(d), h && clearTimeout(h), r = l = d = h = null, u = {}
     }
     ...
     s.component("stackMargin", {
          ...
          init: function() {
               var t, e = this;
               s.$win.on("resize orientationchange", (t = function() {
                    e.process()
               }, s.$(function() {
                    t(), s.$win.on("load", t)
     ...
     var c = h.$win,
          ...
          e = [],
          i = function() {
               for (var t = 0; t < e.length; t++) window.requestAnimationFrame.apply(window, [e[t].check])
          };
     h.component("scrollspy", {
          ...
          boot: function() {
               t.on("scrolling.uk.document", i), c.on("load resize orientationchange", h.Utils.debounce(i, 50)), h.ready(function(t) {
     ...
     h.component("scrollspynav", {
          ...
          boot: function() {
               t.on("scrolling.uk.document", n), c.on("resize orientationchange", h.Utils.debounce(n, 50)), h.ready(function(t) {
          ...
          init: function() {
               var n, t = [],
                    s = this.find("a[href^='#']").each(function() {
                         "#" !== this.getAttribute("href").trim() && t.push(this.getAttribute("href"))
                    }),
                    a = h.$(t.join(",")),
                    r = this.options.cls,
               ...
               }), e(), this.element.data("scrollspynav", this), this.check = e, o.push(this)
          }
     })
}(UIkit2), function(o) {
     "use strict";
     ...
     function p(t, e, i, o) {
          if (t = c.$(t), e = c.$(e), i = i || window.innerWidth, o = o || t.offset(), e.length) {
               var n = e.outerWidth();
               if (t.css("min-width", n), "right" == c.langdirection) {
     ...
     c.component("dropdown", {
          ...
          remainIdle: !1,
          boot: function() {
               var o = c.support.touch ? "click" : "mouseenter";
               c.$html.on(o + ".dropdown.uikit focus pointerdown", "[data-uk-dropdown]", function(t) {
                    var e = c.$(this);
                    if (!e.data("dropdown")) {
                         var i = c.dropdown(e, c.Utils.options(e.attr("data-uk-dropdown")));
          ...
          init: function() {
               ...
               this.dropdown = this.find(this.options.dropdownSelector), this.offsetParent = this.dropdown.parents().filter(function() {
                    return -1 !== c.$.inArray(c.$(this).css("position"), ["relative", "fixed", "absolute"])
               }).slice(0, 1), this.offsetParent.length || (this.offsetParent = this.element), this.centered = this.dropdown.hasClass("uk-dropdown-center"), this.justified = !!this.options.justify && c.$(this.options.justify), this.boundary = c.$(this.options.boundary), this.boundary.length || (this.boundary = c.$win), this.dropdown.hasClass("uk-dropdown-up") && (this.options.pos = "top-left"), this.dropdown.hasClass("uk-dropdown-flip") && (this.options.pos = this.options.pos.replace("left", "right")), this.dropdown.hasClass("uk-dropdown-center") && (this.options.pos = this.options.pos.replace(/(left|right)/, "center")), this.element.attr("aria-haspopup", "true"), this.element.attr("aria-expanded", this.element.hasClass("uk-open")), this.dropdown.attr("aria-hidden", "true"), "click" == this.options.mode || c.support.touch ? this.on("click.uk.dropdown", function(t) {
                    var e = c.$(t.target);
          ...
          show: function() {
               c.$html.off("click.outer.dropdown"), n && n != this && n.hide(!0), o && clearTimeout(o), this.trigger("beforeshow.uk.dropdown", [this]), this.checkDimensions(), this.element.addClass("uk-open"), this.element.attr("aria-expanded", "true"), this.dropdown.attr("aria-hidden", "false"), this.trigger("show.uk.dropdown", [this]), c.Utils.checkDisplay(this.dropdown, !0), c.Utils.focus(this.dropdown), (n = this).registerOuterClick()
          },
          hide: function(t) {
          ...
          registerOuterClick: function() {
               var e = this;
               c.$html.off("click.outer.dropdown"), setTimeout(function() {
                    c.$html.on("click.outer.dropdown", function(t) {
                         o && clearTimeout(o);
                         c.$(t.target);
                         n != e || e.element.find(t.target).length || (e.hide(!0), c.$html.off("click.outer.dropdown"))
                    })
               }, 10)
          },
          checkDimensions: function() {
               if (this.dropdown.length) {
                    ...
                    var t, e = c.$.extend({}, this.offsetParent.offset(), {
                    ...
                    if (t = r.split("-"), d = l[r] ? l[r] : l["bottom-left"], this.justified && this.justified.length) p(o.css({
                         ...
                         switch (this.checkBoundary(e.left + d.left, e.top + d.top, n, s, a)) {
                              case "x":
                                   "x" !== this.options.preventflip && (h = u.x[r] || "right-top");
                                   break;
                              case "y":
                                   "y" !== this.options.preventflip && (h = u.y[r] || "top-left");
                                   break;
                              case "xy":
                                   this.options.preventflip || (h = u.xy[r] || "right-bottom")
                         }
          ...
          checkBoundary: function(t, e, i, o, n) {
               var s = "";
               return (t < 0 || t - c.$win.scrollLeft() + i > n) && (s += "x"), (e - c.$win.scrollTop() < 0 || e - c.$win.scrollTop() + o > window.innerHeight) && (s += "y"), s
          }
     }), c.component("dropdownOverlay", {
          defaults: {
               justify: !1,
               cls: "",
               duration: 200
          ...
          boot: function() {
               c.ready(function(t) {
                    c.$("[data-uk-dropdown-overlay]", t).each(function() {
                         var t = c.$(this);
                         t.data("dropdownOverlay") || c.dropdownOverlay(t, c.Utils.options(t.attr("data-uk-dropdown-overlay")))
                    })
               })
          },
          init: function() {
               var o = this;
               this.justified = !!this.options.justify && c.$(this.options.justify), this.overlay = this.element.find("uk-dropdown-overlay"), this.overlay.length || (this.overlay = c.$('<div class="uk-dropdown-overlay"></div>').appendTo(this.element)), this.overlay.addClass(this.options.cls), this.on({
                    ...
                    "show.uk.dropdown": function(t, e) {
                         ...
                         o.dropdown.element.removeClass("uk-open"), o.overlay.stop().css("display", "block").animate({
                              ...
                              o.dropdown.dropdown.css("visibility", ""), o.dropdown.element.addClass("uk-open"), c.Utils.checkDisplay(o.dropdown.dropdown, !0)
                         }), o.pointerleave = !1
                    },
     ...
     i.component("gridMatchHeight", {
          ...
          init: function() {
               var t, e = this;
               (this.columns = this.element.children(), this.elements = this.options.target ? this.find(this.options.target) : this.columns, this.columns.length) && (i.$win.on("load resize orientationchange", (t = function() {
     ...
     var l = {
          ...
          n = {
               ...
               hide: function(t) {
                    var e = r.$("body"),
                         i = r.$(".uk-offcanvas.uk-active"),
                         o = "right" == r.langdirection,
                         n = i.find(".uk-offcanvas-bar:first"),
                         s = function() {
                              e.removeClass("uk-offcanvas-page").css({
                                   ...
                                   marginLeft: "",
                                   marginRight: ""
                              }), i.removeClass("uk-active"), n.removeClass("uk-offcanvas-bar-show"), d.css("margin-top", ""), window.scrollTo(l.x, l.y), n.trigger("hide.uk.offcanvas", [i, n]), i.attr("aria-hidden", "true")
                         };
                    i.length && ("none" == n.attr("mode") && (t = !0), r.support.transition && !t ? (e.one(r.support.transition.end, function() {
                         s()
                    }).css(o ? "margin-right" : "margin-left", ""), "reveal" == n.attr("mode") && n.css("clip", ""), setTimeout(function() {
                         n.removeClass("uk-offcanvas-bar-show")
                    }, 0)) : s())
               },
     ...
     return u.component("datepicker", {
          defaults: {
               ...
               template: function(t, e) {
                    var i, o = "";
                    if (o += '<div class="uk-datepicker-nav uk-clearfix">', o += '<a href="" class="uk-datepicker-previous"></a>', o += '<a href="" class="uk-datepicker-next"></a>', u.formSelect) {
                         ...
                         if (t.days[i] && t.days[i].length) {
                              ...
                              for (var d = 0; d < t.days[i].length; d++)
                                   if (t.days[i][d]) {
                                        var h = t.days[i][d],
                                             c = [];
                                        h.inmonth || c.push("uk-datepicker-table-muted"), h.selected && c.push("uk-active"), h.disabled && c.push("uk-datepicker-date-disabled uk-datepicker-table-muted"), o += '<td><a href="" class="' + c.join(" ") + '" data-date="' + h.day.format() + '">' + h.day.format("D") + "</a></td>"
                                   } o += "</tr>"
                         } return o += "</tbody>", o += "</table>"
               }
          },
          boot: function() {
               u.$win.on("resize orientationchange", function() {
                    l && l.hide()
               }), u.$html.on("focus.datepicker.uikit", "[data-uk-datepicker]", function(t) {
                    var e = u.$(this);
                    e.data("datepicker") || (t.preventDefault(), u.datepicker(e, u.Utils.options(e.attr("data-uk-datepicker"))), e.trigger("focus"))
               }), u.$html.on("click focus", "*", function(t) {
                    var e = u.$(t.target);
                    !l || e[0] == r[0] || e.data("datepicker") || e.parents(".uk-datepicker:first").length || l.hide()
               })
          },
          init: function() {
               if (!u.support.touch || "date" != this.element.attr("type") || this.options.mobile) {
                    var t = this;
                    ...
                    }), r || ((r = u.$('<div class="uk-dropdown uk-datepicker ' + t.options.addClass + '"></div>')).on("click", ".uk-datepicker-next, .uk-datepicker-previous, [data-date]", function(t) {
          ...
          pick: function(t) {
               ...
               n.top = a, "top" == this.options.pos ? (n.top = s, r.addClass("dp-top")) : "auto" == this.options.pos && window.innerHeight - a - r.outerHeight() + u.$win.scrollTop() < 0 && 0 <= s && (n.top = s, r.addClass("dp-top")), n.minWidth = r.actual("outerWidth"), r.css(n).addClass("uk-dropdown-active uk-dropdown-shown"), this.trigger("show.uk.datepicker"), l = this
          },
          add: function(t, e) {
          ...
          getRows: function(t, e) {
               ...
               for (var l, d, h, c, u, p = n + s, f = p; 7 < f;) f -= 7;
               p += 7 - f;
               for (var m = 0, g = 0; m < p; m++) l = new Date(t, e, m - s + 1, 12), d = a.minDate && a.minDate > l || a.maxDate && l > a.maxDate, u = !(m < s || n + s <= m), l = moment(l), h = this.initdate == l.format("YYYY-MM-DD"), c = i == l.format("YYYY-MM-DD"), r.push({
                    selected: h,
                    today: c,
                    disabled: d,
                    day: l,
     ...
     }), u.Utils.moment = moment(), u.datepicker
}), function(t) {
     var e;
     ...
     w.component("grid", {
          ...
          update: function(t) {
               ...
               var i, o, n, s, a, r, l, d, h, c = t = t || this.element.children(":visible"),
                    u = this.element.width() + 2 * this.gutterh + 2,
                    p = 0,
                    f = 0,
                    m = [];
               this.trigger("beforeupdate.uk.grid", [c]), c.each(function(t) {
                    for (i = w.$(this), h = this.getBoundingClientRect(), o = h.width, n = h.height, r = f = p = 0, d = m.length; r < d; r++) s = m[r], p <= s.aX && (p = s.aX), u < p + o && (p = 0), f <= s.aY && (f = s.aY);
                    (a = {
                         ele: i,
                         top: f,
                         width: o,
     ...
     return p.component("lightbox", {
          ...
          fitSize: function() {
               ...
               var c = h + i,
                    u = Math.floor(window.innerHeight / 2 - c / 2) - o;
               u < 0 && (u = 0), this.modal.closer.addClass("uk-hidden"), t.modal.data("mwidth") == d && t.modal.data("mheight") == h && (s = 0), this.modal.dialog.animate({
                    width: d + i,
                    height: h + i,
                    top: u
               }, s, "swing", function() {
          ...
          init: function(t) {
               ...
               t.on("showitem.uk.lightbox", function(t, o) {
                    ...
                    if ((i = o.source.match(r)) && (e = i[2]), (i = o.source.match(l)) && (e = i[1]), e) {
                         if (h[e]) n(e, h[e].width, h[e].height);
                         else {
                              var s = new Image,
                                   a = !1;
                              s.onerror = function() {
                                   h[e] = {
                                        width: 640,
                                        height: 320
                                   }, n(e, h[e].width, h[e].height)
                              }, s.onload = function() {
                                   120 == s.width && 90 == s.height ? a ? (h[e] = {
                                        width: 640,
                                        height: 320
                                   }, n(e, h[e].width, h[e].height)) : (a = !0, s.src = "//img.youtube.com/vi/" + e + "/0.jpg") : (h[e] = {
                                        width: s.width,
                                        height: s.height
                                   }, n(e, s.width, s.height))
                              }, s.src = "//img.youtube.com/vi/" + e + "/maxresdefault.jpg"
                         }
          ...
          init: function(t) {
               ...
               t.on("showitem.uk.lightbox", function(t, o) {
                    ...
                    (n = o.source.match(s)) && (e = n[2], h[e] ? i(e, h[e].width, h[e].height) : p.$.ajax({
                         type: "GET",
     ...
     var r, s = "ontouchstart" in window || "MSGesture" in window || window.PointerEvent,
          ...
          c = s ? "MSGesture" in window || window.PointerEvent ? "pointercancel" : "touchcancel" : "mouseup";
     return k.component("nestable", {
          ...
          init: function() {
               ...
               s ? (this.element[0].addEventListener(a, t, !1), window.addEventListener(d, e, !1), window.addEventListener(h, i, !1), window.addEventListener(c, i, !1)) : (this.on(a, t), o.on(d, e), o.on(h, i))
          },
          serialize: function() {
               var d = this,
                    h = function(t, r) {
          ...
          dragMove: function(t) {
               ...
               var h = !1,
                    c = t.pageX - (window.pageXOffset || document.scrollLeft || 0),
                    u = t.pageY - (window.pageYOffset || document.documentElement.scrollTop);
               if (this.pointEl = k.$(document.elementFromPoint(c, u)), n.handleClass && this.pointEl.hasClass(n.handleClass)) this.pointEl = this.pointEl.closest(n._listItemClass);
               else {
     ...
     return e.$.extend(i.prototype, {
          ...
          close: function(t) {
               var e = this,
                    i = function() {
                         e.element.remove(), o[e.options.pos].children().length || o[e.options.pos].hide(), e.options.onClose.apply(e, []), e.element.trigger("close.uk.notify", [e]), delete n[e.uuid]
                    };
               this.timeout && clearTimeout(this.timeout), t ? i() : this.element.animate({
                    opacity: 0,
                    marginTop: -1 * this.element.outerHeight(),
                    marginBottom: 0
               }, function() {
     ...
     u.component("slideshow", {
          ...
          boot: function() {
               u.ready(function(t) {
                    u.$("[data-uk-slideshow]", t).each(function() {
                         var t = u.$(this);
                         t.data("slideshow") || u.slideshow(t, u.Utils.options(t.attr("data-uk-slideshow")))
                    })
               })
          },
          init: function() {
               var i = this;
               this.container = this.element.hasClass("uk-slideshow") ? this.element : u.$(this.find(".uk-slideshow:first")), this.current = this.options.start, this.animating = !1, this.fixFullscreen = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) && this.container.hasClass("uk-slideshow-fullscreen"), this.options.kenburns && (this.kbanimduration = !0 === this.options.kenburns ? "15s" : this.options.kenburns, String(this.kbanimduration).match(/(ms|s)$/) || (this.kbanimduration += "ms"), "string" == typeof this.options.kenburnsanimations && (this.options.kenburnsanimations = this.options.kenburnsanimations.split(","))), this.update(), this.on("click.uk.slideshow", "[data-uk-slideshow-item]", function(t) {
                    t.preventDefault();
                    var e = u.$(this).attr("data-uk-slideshow-item");
                    if (i.current != e) {
                         switch (e) {
                              case "next":
                              case "previous":
               ...
               }), u.$win.on("resize load", u.Utils.debounce(function() {
               ...
               }), u.domObserve(this.element, function(t) {
                    ...
                    if (!t.data("processed")) {
                         ...
                         if (t.data("media", o), t.data("sizer", o), o.length) {
                              ...
                              switch (e = o[0].nodeName.toLowerCase(), o[0].nodeName) {
                                   case "IMG":
                                        var s = u.$('<div class="uk-cover-background uk-position-cover"></div>').css({
                                             "background-image": "url(" + o.attr("src") + ")"
                                        });
                                        o.attr("width") && o.attr("height") && (n = u.$("<canvas></canvas>").attr({
                                             width: o.attr("width"),
                                   ...
                                   case "IFRAME":
                                        ...
                                        o.attr("src", "").on("load", function() {
                                             ...
                                             var e
                                        }).data("slideshow", h).attr("data-player-id", r).attr("src", [a, -1 < a.indexOf("?") ? "&" : "?", "enablejsapi=1&api=1&player_id=" + r].join("")).addClass("uk-position-absolute"), u.support.touch || o.css("pointer-events", "none"), n = !0, u.cover && (u.cover(o), o.attr("data-uk-cover", "{}"));
                                        break;
                                   case "VIDEO":
                                        o.addClass("uk-cover-object uk-position-absolute"), n = !0, h.options.videomute && h.mutemedia(o)
                              }
                              if (n) {
                                   d = u.$("<canvas></canvas>").attr({
                                        width: o[0].width,
                                        height: o[0].height
                                   });
                                   var l = u.$('<img style="width:100%;height:auto;">').attr("src", d[0].toDataURL());
                         ...
                         }), t.data("processed", ++c), t.attr("data-slideshow-slide", e)
                    }
               }), c && (this.triggers = this.find("[data-uk-slideshow-item]"), this.slides.attr("aria-hidden", "true").removeClass("uk-active").eq(this.current).addClass("uk-active").attr("aria-hidden", "false"), this.triggers.filter('[data-uk-slideshow-item="' + this.current + '"]').addClass("uk-active")), t && c && this.resize()
          },
          resize: function() {
          ...
          show: function(t, e) {
               if (!this.animating && this.current != t) {
                    ...
                    var i = this,
                         ...
                         l = n.data("media");
                    i.applyKenBurns(n), u.support.animation || (r = "none"), o = u.$(o), n = u.$(n), i.trigger("beforeshow.uk.slideshow", [n, o, i]), d[r].apply(this, [o, n, s]).then(function() {
                         i.animating && (a && a.is("video,iframe") && i.pausemedia(a), l && l.is("video,iframe") && i.playmedia(l), n.addClass("uk-active").attr("aria-hidden", "false"), o.removeClass("uk-active").attr("aria-hidden", "true"), i.animating = !1, i.current = t, u.Utils.checkDisplay(n, '[class*="uk-animation-"]:not(.uk-cover-background.uk-position-cover)'), i.trigger("show.uk.slideshow", [n, o, i]))
          ...
          scroll: function(t, e, i) {
               var o = u.$.Deferred();
               return t.css("animation-duration", this.options.duration + "ms"), e.css("animation-duration", this.options.duration + "ms"), e.css("opacity", 1).one(u.support.animation.end, function() {
          ...
          scale: function(t, e, i) {
               var o = u.$.Deferred();
               return t.css("animation-duration", this.options.duration + "ms"), e.css("animation-duration", this.options.duration + "ms"), e.css("opacity", 1), t.one(u.support.animation.end, function() {
          ...
          fade: function(t, e, i) {
               var o = u.$.Deferred();
               return t.css("animation-duration", this.options.duration + "ms"), e.css("animation-duration", this.options.duration + "ms"), e.css("opacity", 1), e.data("cover") || e.data("placeholder") || e.css("opacity", 1).one(u.support.animation.end, function() {
                    e.removeClass("uk-slideshow-fade-in")
               }).addClass("uk-slideshow-fade-in"), t.one(u.support.animation.end, function() {
                    t.css("opacity", 0).removeClass("uk-slideshow-fade-out"), o.resolve()
               }.bind(this)), t.addClass("uk-slideshow-fade-out"), t.width(), o.promise()
          }
     }, u.slideshow.animations = d, window.addEventListener("message", function(t) {
          var e, i = t.data;
          ...
          t.origin && -1 < t.origin.indexOf("vimeo") && "ready" == i.event && i.player_id && (e = u.$('[data-player-id="' + i.player_id + '"]')).length && e.data("slideshow").mutemedia(e)
     }, !1)
}), function(t) {
     var e;
     ...
     return l.component("slider", {
               ...
               this.container = this.element.find(".uk-slider"), this.focus = 0, l.$win.on("resize load", l.Utils.debounce(function() {
                    ...
                    "touchstart mousedown": function(t) {
                         t.originalEvent && t.originalEvent.touches && (t = t.originalEvent.touches[0]), t.button && 2 == t.button || !i.active || (i.stop(), e = l.$(t.target).is("a") ? l.$(t.target) : l.$(t.target).parents("a:first"), o = !1, e.length && e.one("click", function(t) {
                              ...
                              }, t.originalEvent && t.originalEvent.touches && (t = t.originalEvent.touches[0]), c.element.data({
                                   "pointer-start": {
                                        x: parseInt(t.pageX, 10),
                                        y: parseInt(t.pageY, 10)
                                   },
                                   "pointer-pos-start": i.pos
                              }), i.container.addClass("uk-drag"), u = !1
                         }).x = parseInt(t.pageX, 10), u.threshold = i.options.threshold)
                    },
                    mouseenter: function() {
                         i.options.pauseOnHover && (i.hovering = !0)
                    },
          ...
          if (t.originalEvent && t.originalEvent.touches && (t = t.originalEvent.touches[0]), u && Math.abs(t.pageX - u.x) > u.threshold && (window.getSelection().toString() ? c = u = !1 : u(t)), c) {
               var e, i, o, n, s, a, r, l, d, h;
               if (t.clientX || t.clientY ? e = t.clientX : (t.pageX || t.pageY) && (e = t.pageX - document.body.scrollLeft - document.documentElement.scrollLeft), s = p.focus, i = e - c.element.data("pointer-start").x, o = c.element.data("pointer-pos-start") + i, n = e > c.element.data("pointer-start").x ? -1 : 1, a = c.items.eq(p.focus), 1 == n)
                    for (r = a.data("left") + Math.abs(i), l = 0, d = p.focus; l < c.items.length; l++) {
                         if (h = c.items.eq(d), d != p.focus && h.data("left") < r && h.data("area") > r) {
                              s = d;
                              break
                         }
                         d = d + 1 == c.items.length ? 0 : d + 1
                    } else
                         for (r = a.data("left") - Math.abs(i), l = 0, d = p.focus; l < c.items.length; l++) {
                              if (h = c.items.eq(d), d != p.focus && h.data("area") <= a.data("left") && h.data("center") < r) {
                                   s = d;
                                   break
                              }
                              d = d - 1 == -1 ? c.items.length - 1 : d - 1
                         }
               c.options.infinite && s != p._focus && c.infinite(s, n), c.updatePos(o), p.dir = n, p._focus = s, p.touchx = parseInt(t.pageX, 10), p.diff = r
          }
     }), l.$doc.on("mouseup.uk.slider touchend.uk.slider", function(t) {
          if (c) {
               c.container.removeClass("uk-drag"), c.items.eq(p.focus);
               var e, i, o, n = !1;
               if (1 == p.dir) {
                    for (i = 0, o = p.focus; i < c.items.length; i++) {
                         if (e = c.items.eq(o), o != p.focus && e.data("left") > p.diff) {
                              n = o;
                              break
                         }
                         o = o + 1 == c.items.length ? 0 : o + 1
                    }
                    c.options.infinite || n || (n = c.items.length)
               } else {
                    for (i = 0, o = p.focus; i < c.items.length; i++) {
                         if (e = c.items.eq(o), o != p.focus && e.data("left") < p.diff) {
                              n = o;
                         ...
                         o = o - 1 == -1 ? c.items.length - 1 : o - 1
                    }
                    c.options.infinite || n || (n = 0)
               }
               c.updateFocus(!1 !== n ? n : p._focus)
          }
          c = u = !1
     }), l.slider
}), function(t) {
     ...
     "use strict";
     var d, h, s, c, u, p, f, m, g, v = "ontouchstart" in window || "MSGesture" in window || window.DocumentTouch && document instanceof DocumentTouch,
          ...
          boot: function() {
               l.ready(function(t) {
                    ...
                    if (u) {
                         ...
                         (Math.abs(e.pageX - u.pos.x) > u.threshold || Math.abs(e.pageY - u.pos.y) > u.threshold) && u.apply(e)
                    }
                    if (d) {
                         c || (c = !0, d.show(), d.$current.addClass(d.$sortable.options.placeholderClass), d.$sortable.element.children().addClass(d.$sortable.options.childClass), l.$html.addClass(d.$sortable.options.dragMovingClass));
                    ...
                    if (!(n.length && this.element.find(n[0]).length || o.is(":input"))) {
                         ...
                         u = {
                              ...
                              apply: function(t) {
                                   ...
                                   }), i.addDragHandlers(), i.options.start(this, h), i.trigger("start.uk.sortable", [i, h, d]), u = !(f = !0)
                              }
                         }
                    }
               }
     ...
     function i(t) {
          var e = arguments.length ? arguments : g;
          if (e.length && !(f.scrollTop() < 0))
               for (var i, o, n, s, r = f.scrollTop(), a = m.height(), l = a - f.height(), d = l < r ? l - r : 0, h = 0; h < e.length; h++)
                    if ((s = e[h]).element.is(":visible") && !s.animate) {
                         if (s.check()) {
                              if (i = s.top < 0 ? 0 : (i = a - (n = s.element.outerHeight()) - s.top - s.options.bottom - r - d) < 0 ? i + s.top : s.top, s.boundary && s.boundary.length) {
                                   var c = s.boundary.offset().top;
                                   o = s.boundtoparent ? a - (c + s.boundary.outerHeight()) + parseInt(s.boundary.css("padding-bottom")) : a - c, i = r + n > a - o - (s.top < 0 ? 0 : s.top) ? a - o - (r + n) : i
                              }
                              if (s.currentTop != i) {
                                   if (s.element.css({
                                             position: "fixed",
                                             top: i,
                                             width: s.getWidthFrom.length ? s.getWidthFrom.width() : s.element.width()
                                        }), !s.init && (s.element.addClass(s.options.clsinit), location.hash && 0 < r && s.options.target)) {
                                   ...
                                   s.element.addClass(s.options.clsactive).removeClass(s.options.clsinactive), s.element.trigger("active.uk.sticky"), s.element.css("margin", ""), s.options.animation && s.init && !p.Utils.isInView(s.wrapper) && s.element.addClass(s.options.animation), s.currentTop = i
                              }
                         } else null !== s.currentTop && s.reset();
                         s.init = !0
                    }
     }
     return p.component("sticky", {
          defaults: {
               top: 0,
               bottom: 0,
               animation: "",
          ...
          boot: function() {
               p.$doc.on("scrolling.uk.document", function(t, e) {
                    e && e.dir && (n = e.dir.y, i())
               }), p.$win.on("resize orientationchange", p.Utils.debounce(function() {
                    if (g.length) {
                         for (var t = 0; t < g.length; t++) g[t].reset(!0), g[t].self.computeWrapper();
                         i()
                    }
               }, 100)), p.ready(function(t) {
                    setTimeout(function() {
                         p.$("[data-uk-sticky]", t).each(function() {
                              var t = p.$(this);
                              t.data("sticky") || p.sticky(t, p.Utils.options(t.attr("data-uk-sticky")))
                         }), i()
                    }, 0)
               })
          },
          init: function() {
               ...
               this.wrapper = this.element.wrap('<div class="uk-sticky-placeholder"></div>').parent(), this.computeWrapper(), this.wrapper.css({
               ...
               }), this.element.css("margin", 0), e && (!0 === e || "!" === e[0] ? (e = !0 === e ? this.wrapper.parent() : this.wrapper.closest(e.substr(1)), t = !0) : "string" == typeof e && (e = p.$(e))), this.sticky = {
                    self: this,
                    ...
                    init: !1,
                    getWidthFrom: p.$(this.options.getWidthFrom || this.wrapper),
                    boundary: e,
                    boundtoparent: t,
                    top: 0,
                    calcTop: function() {
                         ...
                         if (this.options.top && "string" == typeof this.options.top)
                              if (this.options.top.match(/^(-|)(\d+)vh$/)) t = window.innerHeight * parseInt(this.options.top, 10) / 100;
                                   ...
                                   var e = p.$(this.options.top).first();
                    ...
                    reset: function(t) {
                         ...
                         !t && this.options.animation && p.support.animation && !p.Utils.isInView(this.wrapper) ? (this.animate = !0, this.element.removeClass(this.options.animation).one(p.support.animation.end, function() {
                              e()
                    ...
                    check: function() {
                         ...
                         var t = f.scrollTop(),
                              e = m.height() - window.innerHeight,
                              i = e < t ? e - t : 0,
                              o = this.wrapper.offset().top - this.top - i <= t;
                         return o && this.options.showup && (1 == n && (o = !1), -1 == n && !this.element.hasClass(this.options.clsactive) && p.Utils.isInView(this.wrapper) && (o = !1)), o
                    }
               }, this.sticky.calcTop(), g.push(this.sticky)
          },
          update: function() {
               i(this.sticky)
          },
     ...
     return f.component("tooltip", {
          ...
          show: function() {
               if (this.tip = "function" == typeof this.options.src ? this.options.src(this.element) : this.options.src, g && clearTimeout(g), v && clearInterval(v), "string" == typeof this.tip && this.tip.length) {
                    ...
                    f.$.extend(r, u[a[0]]), 2 == a.length && (r.left = "left" == a[1] ? e.left : e.left + e.width - i);
                    ...
                    if (p) {
                         ...
                         a = s.split("-"), f.$.extend(r, u[a[0]]), 2 == a.length && (r.left = "left" == a[1] ? e.left : e.left + e.width - i)
                    }
     ...
     o.component("timepicker", {
          ...
          checkTime: function() {
               ...
               "12h" == this.options.format ? (e = (t = s.split(" "))[0].split(":"), n = t[1]) : e = s.split(":"), i = parseInt(e[0], 10), o = parseInt(e[1], 10), isNaN(i) && (i = 0), isNaN(o) && (o = 0), "12h" == this.options.format ? (12 < i ? i = 12 : i < 0 && (i = 12), "am" === n || "a" === n ? n = "AM" : "pm" !== n && "p" !== n || (n = "PM"), "AM" !== n && "PM" !== n && (n = "AM")) : 24 <= i ? i = 23 : i < 0 && (i = 0), o < 0 ? o = 0 : 60 <= o && (o = 0), this.autocomplete.input.val(this.formatTime(i, o, n)).trigger("change")
          },
          ...
          if (o = d.$.extend({}, h.defaults, o), i.length) {
               if ("*.*" !== o.allow)
                    for (var t, e = 0; t = i[e]; e++)
                         if (!c(o.allow, t.name)) return void("string" == typeof o.notallowed ? alert(o.notallowed) : o.notallowed(t, o));
               var n = o.complete;
               if (o.single) {
                    var s = i.length,
                         a = 0,
...
UIkit.on("beforeready.uk.dom", function() {
     ...
     void 0 !== UIkit.components.accordion && $.extend(UIkit.components.accordion.prototype.defaults, {
          ...
          var t = this.dropdown;
          return t.removeClass("uk-dropdown-shown"), setTimeout(function() {
               t.removeClass("uk-dropdown-active")
          }, 280), e.apply(this, arguments)
