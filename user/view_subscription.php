...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    while ($row = $res->fetch_object()) {
        if ($row->s_cover_img == "") {
            $cover_image =
                "<img src='../sudo/assets/img/books/Image12.jpg' alt='Book Image'>";
        } else {
        ...
        <div id="page_content">
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="view_subscription.php">View</a></li>
                            ...
                            <div class="user_content">
                                ...
                                <div class="md-card md-card-hover">
                                        <div class="gallery_grid_item md-card-content">
                                            <a href="magazine.php?s_id=<?php echo $row->s_id; ?>" class="custom-modal-open" data-image-id="7">
