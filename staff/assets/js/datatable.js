! function(e, t, i) {
	var a = function(e, i) {
		...
		e.extend(!0, i.defaults, {
			...
			var r, u, c, f = new i.Api(a),
				p = a.oClasses,
				b = a.oLanguage.oPaginate,
				T = 0,
				h = function(t, i) {
					var n, s, c, k, m = function(t) {
						t.preventDefault(), e(t.currentTarget).hasClass("disabled") || f.page(t.data.action).draw(!1)
					};
						...
						if (k = i[n], e.isArray(k)) h(t, k);
							...
							switch (r = "", u = "", k) {
								case "ellipsis":
									...
									break;
								case "first":
									r = '<i class="uk-icon-angle-double-left"/>', u = k + (o > 0 ? "" : " uk-disabled");
									break;
								case "previous":
									r = b.sPrevious, u = k + (o > 0 ? "" : " uk-disabled");
									break;
								case "next":
									r = b.sNext, u = k + (o < l - 1 ? "" : " uk-disabled");
									break;
								case "last":
									r = '<i class="uk-icon-angle-double-right"/>', u = k + (o < l - 1 ? "" : " uk-disabled");
									break;
								default:
							...
							r && (c = e("<li>", {
								...
								id: 0 === d && "string" == typeof k ? a.sTableId + "_" + k : null
							}).append(e("<a>", {
								href: "#",
								"aria-controls": a.sTableId,
								"data-dt-idx": T,
								tabindex: a.iTabIndex
							}).html(r)).appendTo(t), a.oApi._fnBindAction(c, {
								action: k
							}, m), T++)
						}
				};
			...
			h(e(n).empty().html('<ul class="uk-pagination"/>').children("ul"), s), c && e(n).find("[data-dt-idx=" + c + "]").focus()
		}, i.TableTools && (e.extend(!0, i.TableTools.classes, {
	...
	$("body").on("init.dt", ".dt-uikit", function() {
		if (!$(this).hasClass("md-processed")) {
			...
			e.find(".md-input").attr("placeholder", t).unwrap(), e.contents().filter(function() {
				return 3 == this.nodeType
			}).remove(), altair_md.inputs(), $(this).find(".dt-selectize").selectize({
				dropdownParent: "body",
			...
			}), $(this).find(".ColVis_MasterButton").addClass("md-btn"), $(this).addClass("md-processed")
		}
