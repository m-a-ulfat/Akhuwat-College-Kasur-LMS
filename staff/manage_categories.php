    ...
    <!--BreadCrumps-->
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><span>Manage Book Category</span></li>
            </ul>
        </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="edit_book_category.php?category_code=<?php echo $row->bc_code;?>">
                                            <span class='uk-badge uk-badge-primary'>Update</span>
                                        </a>
                                        <a href="manage_categories.php?deleteBookCategory=<?php echo $row->bc_id;?>">
