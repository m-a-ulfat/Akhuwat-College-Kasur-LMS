...
if (isset($_POST["report_lost"])) {
    ...
    if ($stmt && $stmt1 && $fine_stmt && $stmt2) {
        $success =
            "Book Reported Lost" &&
            header("refresh:1;url=library_operations_lost_book.php");
    } else {
    ...
    <div id="page_content">
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="library_operations_lost_book.php">Library Operations</a></li>
                            ...
                            <div class="uk-grid" data-uk-grid-margin>
                                ...
                                <div class="uk-width-medium-2-2">
                                    ...
                                    <div class="uk-form-row" style="display:non">
                                        ...
                                        ); ?>" required name="" class="md-input"  />
                                    </div>

                                    <?php
                                    //Get charges of a lost book
                                    $ret =
                                        "SELECT * FROM  iL_ChargesRates WHERE cr_name = 'Lost Book' ";
                                    $stmt = $mysqli->prepare($ret);
                                    $stmt->execute(); //ok
                                    $res = $stmt->get_result();
                                    while ($row = $res->fetch_object()) { ?>
