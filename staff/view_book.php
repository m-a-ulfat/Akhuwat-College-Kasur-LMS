...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    while ($row = $res->fetch_object()) {
        ...
        if ($row->b_coverimage == "") {
            ...
            $cover_image = "<img src='../admin/assets/img/books/$row->b_coverimage' alt='Book Image'>";
        } ?>
        <div id="page_content">
            <!--Breadcrums-->
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="manage_books.php">Books Inventory</a></li>
            ...
            <div id="page_content_inner">
                <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
                    <div class="uk-width-large-10-10">
                        <div class="md-card">
                            <div class="user_heading user_heading_bg" style="background-image: url('../admin/assets/img/books/<?php echo $row->b_coverimage; ?>')">
